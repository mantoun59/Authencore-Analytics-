  ...
  const downloadReport = async () => {
    try {
      const reportData = {
        ...
        ...assessmentResults,
        reportType: 'careerlaunch-applicant'
      };
      ...
      if (response.data) {
        ...
        toast({
          ...
          description: "Your CareerLaunch report has been downloaded successfully.",
        });
      }
    } catch (error) {
            ...
            <Card className="mb-8">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Your Career Profile: {assessmentResults.career_fit?.label}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg mb-4">Best-fit career suggestions:</p>
