          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  This Privacy Policy is designed to comply with applicable privacy laws and regulations, including but not limited to the General Data Protection Regulation (GDPR), California Consumer Privacy Act (CCPA), and other relevant jurisdictional requirements.
                </p>
              </section>
