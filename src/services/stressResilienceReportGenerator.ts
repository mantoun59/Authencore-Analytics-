    ...
    <div class="report-container">
        ...
        <div class="footer">
            <div style="background: linear-gradient(135deg, #f8fafc, #e2e8f0); padding: 30px; border-radius: 16px; margin-bottom: 20px;">
                <h3 style="color: ${profile.color}; margin-bottom: 15px; font-size: 1.1rem;">🔒 Confidentiality & Privacy Notice</h3>
                <div style="color: hsl(var(--muted-foreground)); font-size: 0.9rem; line-height: 1.6;">
                    <p><strong>Confidentiality:</strong> This stress resilience assessment contains confidential psychological data. Access is restricted to authorized personnel only. Unauthorized disclosure is strictly prohibited.</p>
                    ...
                    <p style="margin-top: 10px;"><strong>Professional Use:</strong> This report is intended for stress management and resilience development purposes only. Results should be interpreted by qualified professionals.</p>
            ...
            <p style="text-align: center; color: hsl(var(--muted-foreground)); font-size: 0.85rem;">
                <strong>AuthenCore Analytics</strong> - Professional Assessment Platform<br>
                Report Generated: ${new Date().toLocaleDateString()} | 
                For privacy inquiries: privacy@authencore.com
            </p>
            <p style="text-align: center; margin-top: 10px; font-size: 0.8rem; color: hsl(var(--muted-foreground));">
                This assessment is based on validated psychological instruments and should be used as part of a comprehensive evaluation process.<br>
