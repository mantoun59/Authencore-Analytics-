...
export const assessmentsData: AssessmentData[] = [
  ...
  },
  {
    ...
    questions: 100,
    description: 'Comprehensive personality assessment with advanced validity detection and dual reporting',
    detailedDescription: 'The CAIR+ Personality Assessment is a scientifically validated personality evaluation tool that measures four core dimensions crucial for workplace success. Built with advanced validity detection mechanisms, this assessment provides reliable insights into personality traits that predict performance, job satisfaction, and team dynamics.',
    whatItMeasures: [
  ...
  },
  {
    ...
    whatItMeasures: [
      ...
      'Performance maintenance during stress',
      'Burnout risk factors',
      'Recovery and coping mechanisms',
      'Stress-induced decision making'
    ],
    dimensions: [
      { name: 'Emotional Resilience', description: 'Ability to maintain emotional stability under stress' },
      { name: 'Cognitive Flexibility', description: 'Mental adaptability and problem-solving under pressure' },
      { name: 'Performance Consistency', description: 'Maintaining work quality during challenging periods' },
      { name: 'Stress Recovery', description: 'Speed and effectiveness of stress recovery' },
      { name: 'Burnout Resistance', description: 'Susceptibility to workplace burnout' },
      { name: 'Pressure Performance', description: 'Enhanced or diminished performance under pressure' }
    ],
    features: [
      'Progressive stress loading simulation',
      'Biometric response patterns',
      'Real-time adaptation measurement',
    ...
    badges: ['Popular', 'Biometric Sim', 'Progressive Loading'],
  ...
  },
  {
    id: 'faith-values',
    title: 'Faith & Values',
    subtitle: 'Values-Based Assessment',
    price: '$14.99',
    duration: '12-15 minutes',
    questions: 45,
    description: 'Values-based assessment exploring the intersection of personal beliefs and professional life',
    detailedDescription: 'The Faith & Values Assessment explores how personal beliefs, values, and worldview influence professional decisions and workplace interactions. This thoughtful assessment helps individuals understand the role of their core values in career satisfaction and ethical decision-making.',
    whatItMeasures: [
    ...
    dimensions: [
      { name: 'Core Values', description: 'Fundamental beliefs and principles that guide behavior' },
      { name: 'Ethical Framework', description: 'Moral reasoning and ethical decision-making approach' },
      { name: 'Purpose Alignment', description: 'Connection between personal purpose and professional life' },
      { name: 'Values Integration', description: 'How personal values influence workplace behavior' },
      { name: 'Spiritual Intelligence', description: 'Use of spiritual resources in personal and professional growth' },
      { name: 'Values Leadership', description: 'Leading and inspiring others through shared values' }
    ],
    features: [
      ...
      'Values-culture fit analysis',
      'Spiritual intelligence measurement',
      'Values development planning',
      'Meaningful work identification'
    ],
    badges: ['Values-Based', 'Purpose-Driven', 'Ethical Leadership'],
    route: '/faith-values',
    icon: 'Lightbulb',
    color: 'amber',
